...
|---|---|---|
| `cmd/concierge` | `main.go` | Entry point: loads config, initializes clients (Slack, GitHub, Linear), starts handler |
...
sequenceDiagram
    ...
    participant Ch as #concierge-requests
    ...
    B->>Ch: posts summary to #concierge-requests
